    ...
    <>
      <section id="home" className="w-full flex flex-col justify-center items-center h-screen min-h-screen bg-cover bg-center bg-no-repeat bg-[url(/assets/mobile/stars_bg.png)] xl:bg-[url(/assets/desktop/stars_bg.png)]">
        ...
        <div className='p-1 md:p-10 flex gap-2 md:gap-4'>
          <a href="#chapter1" className='text-nowrap font-planc px-3 md:px-8 rounded-full border-1 text-[#e67ea7] border-[#e67ea7] hover:text-[black] hover:bg-[#e67ea7] cursor-pointer'>Leer novela</a>
          <NavLink className='text-nowrap font-planc px-3 md:px-8 rounded-full border-1 text-[#e67ea7] border-[#e67ea7] hover:text-[black] hover:bg-[#e67ea7] cursor-pointer' to="/store">Explorar tienda</NavLink>
        </div>
      </section>
